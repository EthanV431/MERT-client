  ...
  return (
    <Router basename="/mert">
      <Routes>
        ...
        <Route
          path="/weatherStationWindSpeed"
          element={<WeatherStationWindSpeed />}
        />
        <Route
          path="/weatherStationPressure"
          element={<WeatherStationPressure />}
        />
        <Route
          path="/weatherStationLightning"
          element={<WeatherStationLightning />}
        />
        <Route
          path="/weatherStationSolarRadiation"
          element={<WeatherStationSolarRadiation />}
        />
        <Route
          path="/weatherStationTemperature"
          element={<WeatherStationTemperature />}
        />
        <Route
          path="/weatherStationPercipitation"
          element={<WeatherStationPercipitation />}
        />
      </Routes>
    </Router>
  );
